...
Router.get(
  "/branch/:branchId",
  checkBranchAccess,
  branchProductController.getByBranch,
);
Router.get(
  "/branch/:branchId/barcode/:barcode",
  checkBranchAccess,
  branchProductController.getByBarcode,
);
// Get stock info
Router.get(
  "/stats",
  authorize("admin", "manager", "staff"),
  branchProductController.getStats,
);
// Get aggregated stock by product (admin only - for "All branches" view)
Router.get(
  "/aggregated",
  authorize("admin"),
  branchProductController.getAggregatedByProduct,
);
Router.get("/product/:productId", branchProductController.getByProduct);
Router.get(
  "/branch/:branchId/product/:productId",
  checkBranchAccess,
  branchProductController.getStock,
);
Router.get(
  "/branch/:branchId/low-stock",
  checkBranchAccess,
  branchProductController.getLowStock,
);
Router.get(
...
Router.get(
  "/",
  authorize("admin", "manager", "staff"),
  branchProductController.getAll,
);
...
Router.post(
  "/with-product",
  authorize("admin"),
  branchProductController.createProductWithStock,
);

// Update stock (Admin, Manager & Staff)
Router.put(
  "/:id",
  authorize("admin", "manager", "staff"),
  branchProductController.update,
);
...
Router.patch(
  "/:id/note",
  authorize("admin", "manager", "staff"),
  branchProductController.updateNote,
);
...
Router.patch(
  "/:id/sale-price",
  authorize("admin", "manager", "staff"),
  branchProductController.updateSalePrice,
);
...
Router.patch(
  "/:id/min-stock",
  authorize("admin", "manager", "staff"),
  branchProductController.updateMinStock,
);

// Update status (Admin, Manager & Staff) - cập nhật trạng thái bán
Router.patch(
  "/:id/status",
  authorize("admin", "manager", "staff"),
  branchProductController.updateStatus,
);
